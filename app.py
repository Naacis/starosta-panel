"""
Онлайн-панель старосты на Streamlit.
...
def login_screen():
    ...
    with col2:
        ...
        st.caption("По умолчанию: `starosta / starosta123`, "
                   "`zam / zam123`, `kurator / kurator123`")
